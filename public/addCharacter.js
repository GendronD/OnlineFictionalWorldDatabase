module.exports = function(){
  ...
  router.post('/addCharacter', function(req,res){
    ...
    var sql = 'INSERT INTO Characters (`firstName`, `lastName`, `description`, `univID`) VALUES (?, ?, ?, ?)';
    var inserts = [req.body.firstname, req.body.lastname, req.body.description, req.body.univID];
